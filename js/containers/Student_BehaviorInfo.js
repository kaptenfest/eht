...
export class StudentBehaviorInfo extends Component {
				...
				<form onSubmit={this.handleFormSubmit.bind(this)}>
					...
					<div className="difficulty_checkbox">
						...
						<label className="checkbox">
							<input
								type="checkbox"
								value={this.state.rulesIssue}
								checked={this.state.rulesIssue}
								onChange={this.handleRulesIssue}
							/>
							<span></span>
						</label>
					</div>
					<p id={this.state.rulesInput}>1-3 = Text. 3-6 = Text2. 6-10: Text3</p>
					<div className="row_align" id={this.state.rulesInput}>
						<input
							type="range"
							className="behavior_range"
							value={this.state.selectedRulesFrequency}
							min="1"
							max="10"
							step="1"
							onChange={this.handleFrequencyRules}
						/>
					...
					<div className="difficulty_checkbox">
						...
						<label className="checkbox">
							<input
								type="checkbox"
								value={this.state.verbalIssue}
								checked={this.state.verbalIssue}
								onChange={this.handleVerbalIssue}
							/>
							<span></span>
						</label>
					</div>
					<p id={this.state.verbalInput}>1-3 = Text. 3-6 = Text2. 6-10: Text3</p>
					<div className="row_align" id={this.state.verbalInput}>
						<input
							type="range"
							className="behavior_range"
							value={this.state.selectedVerbalFrequency}
							min="1"
							max="10"
							step="1"
							onChange={this.handleFrequencyVerbal}
						/>
					...
					<div className="difficulty_checkbox">
						...
						<label className="checkbox">
							<input
								type="checkbox"
								value={this.state.aggressiveIssue}
								checked={this.state.aggressiveIssue}
								onChange={this.handleAggressiveIssue}
							/>
							<span></span>
						</label>
					</div>
					<p id={this.state.aggressiveInput}>1-3 = Text. 3-6 = Text2. 6-10: Text3</p>
					<div className="row_align" id={this.state.aggressiveInput}>
						<input
							type="range"
							className="behavior_range"
							value={this.state.selectedAggressiveFrequency}
							min="1"
							max="10"
							step="1"
							onChange={this.handleFrequencyAggressive}
						/>
					...
					<div className="difficulty_checkbox">
						...
						<label className="checkbox">
							<input
								type="checkbox"
								value={this.state.seclusiveIssue}
								checked={this.state.seclusiveIssue}
								onChange={this.handleSeclusiveIssue}
							/>
							<span></span>
						</label>
					</div>
					<p id={this.state.seclusiveInput}>1-3 = Text. 3-6 = Text2. 6-10: Text3</p>
					<div className="row_align" id={this.state.seclusiveInput}>
						<input
							type="range"
							className="behavior_range"
							value={this.state.selectedSeclusiveFrequency}
							min="1"
							max="10"
							step="1"
							onChange={this.handleFrequencySeclusive}
						/>
	...
	handleFormSubmit(formSubmitEvent){
		...
		switch (this.state.behaviorValue) {
			case 'Matsal':
				this.setState({matsal: true});
				break;
			case 'Rast inne':
				this.setState({rastInne: true});
				break;
			case 'Rast ute':
				this.setState({rastUte: true});
				break;
			case 'Gruppsamlingar':
				this.setState({gruppsamlingar: true});
				break;
			case 'Friluftsdagar / Större planerade aktiviteter':
				this.setState({frilutsdagar: true});
				break;
			case 'Styrd lek':
				this.setState({styrdLek: true});
				break;
			case 'Fri lek':
				this.setState({friLek: true});
				break;
			case 'Korridor':
				this.setState({korridor: true});
				break;
			case 'Övergångar':
				this.setState({overgangar: true});
				break;
			default:
				console.log("No behavior selected");
		}
		...
		addBehavior(
			...
			this.state.rulesIssue,
			this.state.selectedRulesFrequency,
			this.state.verbalIssue,
			this.state.selectedVerbalFrequency,
			this.state.aggressiveIssue,
			this.state.selectedAggressiveFrequency,
			this.state.seclusiveIssue,
			this.state.selectedSeclusiveFrequency
		);
		...
		for(var behaviorID in this.props.currentErrandReducer[0].behavior){
			...
			behaviorArray.push(
				<div key={behaviorID} className="container show_behavior_container">
					...
					<button className="delete" onClick={this.delBehavior.bind(this, behaviorID, this.props.currentErrandReducer[0].behavior[behaviorID].behaviorValue)}>Radera situation</button>
				</div>
			)
	...
	delBehavior(behaviorID, behavior){
		...
		firebase.auth().onAuthStateChanged(user => {
			...
			switch (behavior) {
				case 'Matsal':
					this.setState({matsal: false});
					break;
				case 'Rast inne':
					this.setState({rastInne: false});
					break;
				case 'Rast ute':
					this.setState({rastUte: false});
					break;
				case 'Gruppsamlingar':
					this.setState({gruppsamlingar: false});
					break;
				case 'Friluftsdagar / Större planerade aktiviteter':
					this.setState({frilutsdagar: false});
					break;
				case 'Styrd lek':
					this.setState({styrdLek: false});
					break;
				case 'Fri lek':
					this.setState({friLek: false});
					break;
				case 'Korridor':
					this.setState({korridor: false});
					break;
				case 'Övergångar':
					this.setState({overgangar: false});
					break;
				default:
					console.log("No behavior selected");
			}
						...
						<div>
							<div className="container">
								<select
									...
									onChange={this.showBehavior.bind(this)}
								>
									<option selected disabled>Situationer där hinder uppstår:</option>
									<option disabled={this.state.matsal} value="Matsal">Matsal</option>
									<option disabled={this.state.rastInne} value="Rast inne">Rast inne</option>
									<option disabled={this.state.rastUte} value="Rast ute">Rast ute</option>
									<option disabled={this.state.gruppsamlingar} value="Gruppsamlingar">Gruppsamlingar</option>
									<option disabled={this.state.frilutsdagar} value="Friluftsdagar / Större planerade aktiviteter">Friluftsdagar / Större planerade aktiviteter</option>
									<option disabled={this.state.styrdLek} value="Styrd lek">Styrd lek</option>
									<option disabled={this.state.friLek} value="Fri lek">Fri lek</option>
									<option disabled={this.state.korridor} value="Korridor">Korridor</option>
									<option disabled={this.state.overgangar} value="Övergångar">Övergångar</option>
								</select>
							</div>
